...
SECRET_KEY = '&i!65*7)1i61jmu#2n%5jh4&kbb5pz_druakikkql+!*4v80)s'
...
AUTH_USER_MODEL = 'jarvis.User'

# Database
# https://docs.djangoproject.com/en/2.2/ref/settings/#databases

#SQLITE 3 ka default database settings
# DATABASES = {
#     'default': {
...
# POSTgres ko database bnane ka tarika
DATABASES={
    'default':{
...
#definning the authentication class
REST_FRAMEWORK={
